 ...
 *
 * This file is part of gnome-shell-extension-status-menu-buttons.
 *
 * gnome-shell-extension-status-menu-buttons is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation; either version 3 of the License, or
 * (at your option) any later version.
 *
 * gnome-shell-extension-status-menu-buttons is distributed in the hope that it will be useful,
 ...
 * along with gnome-shell-extension-status-menu-buttons; If not, see <http://www.gnu.org/licenses/>.
 */
